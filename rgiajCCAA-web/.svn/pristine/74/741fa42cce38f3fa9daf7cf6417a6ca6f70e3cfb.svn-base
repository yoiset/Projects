...
String.prototype.ltrim = function() {
 ...
 <div id="formulcuad">  
              ...
              <form:form id="saveForm" action="${pageContext.request.contextPath}/app/carta/saveNewCarta"
              	modelAttribute="${modelAttribute}">
					...
					<div class="breadcrumb">
					  ...
					  <ul class="breadcrumb">
					    ...
					    <li><a href="#" class="active"><spring:message code="page.carta.li.create.title"/></a></li>
					  </ul>
					...
					<div class="listado">
						<div class="encabezado">
				  			<label for="usuario">  					
								<span class="label">
				 					<spring:message code="page.breadcrumb.newCarta"/>										
								</span>
				 			</label>  								
						</div>		
					</div>
                      ...
                      <label for="id" class="linea-medio">
                        ...
                        <form:input id="id" path="id" maxlength="10" title='${msg["page.carta.form.codigo.title"]}'/>
