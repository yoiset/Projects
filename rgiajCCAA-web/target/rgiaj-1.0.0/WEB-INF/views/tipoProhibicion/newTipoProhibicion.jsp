...
String.prototype.ltrim = function() {
 ...
 <div id="formulcuad">  
              ...
              <form:form id="saveForm" action="${pageContext.request.contextPath}/app/tipoProhibicion/saveNewTipoProhibicion"
              	modelAttribute="${modelAttribute}">
					...
					<div class="breadcrumb">
					  ...
					  <ul class="breadcrumb">
					    ...
					    <li><a href="#" class="active"><spring:message code="page.tipoProhibicion.li.create.title"/></a></li>
					  </ul>
					...
					<div class="listado">
						<div class="encabezado">
				  			<label for="usuario">  					
								<span class="label">
				 					<spring:message code="page.breadcrumb.newTipoProhibicion"/>										
								</span>
				 			</label>  								
						</div>		
					</div>
