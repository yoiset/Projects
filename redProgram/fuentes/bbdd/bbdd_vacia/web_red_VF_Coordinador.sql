...
CREATE TABLE `Coordinador` (
  ...
  KEY `fk_Coordinador_Agencias1_idx` (`Agencias_id`),
  CONSTRAINT `fk_Coordinador_Agencias1` FOREIGN KEY (`Agencias_id`) REFERENCES `Agencias` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
