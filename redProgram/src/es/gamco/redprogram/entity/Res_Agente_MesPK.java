...
@Embeddable
public class Res_Agente_MesPK implements Serializable{
	...
	private int agentes_id;
	
	
	@Column(name="Ej_Fiscal_id")
	private int ej_Fiscal_id;
	...
	public int getAgentes_id() {
		return agentes_id;
	}


	public void setAgentes_id(int agentes_id) {
		this.agentes_id = agentes_id;
	}


	public int getEj_Fiscal_id() {
		return ej_Fiscal_id;
	}


	public void setEj_Fiscal_id(int ej_Fiscal_id) {
