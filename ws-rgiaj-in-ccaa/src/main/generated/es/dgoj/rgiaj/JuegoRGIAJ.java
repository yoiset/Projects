 ...
 * 2013-12-04T18:32:29.092+01:00
 * Generated source version: 2.7.0
 * 
 */
@WebService(targetNamespace = "http://rgiaj.dgoj.es/", name = "JuegoRGIAJ")
@XmlSeeAlso({ObjectFactory.class})
@SOAPBinding(parameterStyle = SOAPBinding.ParameterStyle.BARE)
public interface JuegoRGIAJ {
    ...
    public boolean hayPendiente(
        @WebParam(partName = "parameters", name = "JugProhibicionQueryRequest4", targetNamespace = "http://rgiaj.dgoj.es/")
        JugProhibicionQueryRequest parameters
    ) throws Fault;
    ...
    public void confirmHistoricoDescargasPendientes(
        @WebParam(partName = "parameters", name = "JugProhibicionQueryRequest3", targetNamespace = "http://rgiaj.dgoj.es/")
        JugProhibicionQueryRequest parameters
    ) throws Fault;

    @WebMethod(action = "http://rgiaj.dgoj.es/JuegoRGIAJ/updateCertificadoComunidad")
    public void updateCertificadoComunidad(
        @WebParam(partName = "parameters", name = "ComunidadQueryRequest4", targetNamespace = "http://rgiaj.dgoj.es/")
        ComunidadQueryRequest parameters
    ) throws Fault;

    @Oneway
    @WebMethod(action = "http://rgiaj.dgoj.es/JuegoRGIAJ/editUsuario")
    public void editUsuario(
        @WebParam(partName = "parameters", name = "UsuarioQueryRequest2", targetNamespace = "http://rgiaj.dgoj.es/")
        UsuarioQueryRequest parameters
    ) throws Fault;
    ...
    public boolean existCertificadoActivoOtraComunidad(
        @WebParam(partName = "parameters", name = "ComunidadQueryRequest8", targetNamespace = "http://rgiaj.dgoj.es/")
        ComunidadQueryRequest parameters
    ) throws Fault;
    ...
    public UltimasDescargasConfirmadasResponse ultimasDescargasConfirmadas(
        @WebParam(partName = "parameters", name = "JugProhibicionQueryRequest5", targetNamespace = "http://rgiaj.dgoj.es/")
        JugProhibicionQueryRequest parameters
    ) throws Fault;
    ...
    public void confirmHistoricoDescargas(
        @WebParam(partName = "parameters", name = "JugProhibicionQueryRequest2", targetNamespace = "http://rgiaj.dgoj.es/")
        JugProhibicionQueryRequest parameters
    ) throws Fault;
    ...
    public boolean existCertificadoComunidad(
        @WebParam(partName = "parameters", name = "ComunidadQueryRequest7", targetNamespace = "http://rgiaj.dgoj.es/")
        ComunidadQueryRequest parameters
    ) throws Fault;
    ...
    public boolean isCertificadoActivo(
        @WebParam(partName = "parameters", name = "ComunidadQueryRequest5", targetNamespace = "http://rgiaj.dgoj.es/")
        ComunidadQueryRequest parameters
    ) throws Fault;
    ...
    public void addCertificadoComunidad(
        @WebParam(partName = "parameters", name = "ComunidadQueryRequest14", targetNamespace = "http://rgiaj.dgoj.es/")
        ComunidadQueryRequest parameters
    ) throws Fault;
    ...
    public void addUsuario(
        @WebParam(partName = "parameters", name = "UsuarioQueryRequest1", targetNamespace = "http://rgiaj.dgoj.es/")
        UsuarioQueryRequest parameters
    ) throws Fault;
    ...
    public boolean existOtroCertificadoActivoComunidad(
        @WebParam(partName = "parameters", name = "ComunidadQueryRequest2", targetNamespace = "http://rgiaj.dgoj.es/")
        ComunidadQueryRequest parameters
    ) throws Fault;
    ...
    public ComunidadSearchResponse getUsuarioComunidad(
        @WebParam(partName = "parameters", name = "ComunidadQueryRequest13", targetNamespace = "http://rgiaj.dgoj.es/")
        ComunidadQueryRequest parameters
    ) throws Fault;
    ...
    public boolean existUsuario(
        @WebParam(partName = "parameters", name = "UsuarioQueryRequest", targetNamespace = "http://rgiaj.dgoj.es/")
        UsuarioQueryRequest parameters
    ) throws Fault;

    @WebResult(name = "JugProhibicionBeanWS", targetNamespace = "http://rgiaj.dgoj.es/", partName = "parameters")
    @WebMethod(action = "http://rgiaj.dgoj.es/JuegoRGIAJ/getComunidad")
    public JugProhibicionBeanWS getComunidad(
        @WebParam(partName = "user", name = "user", targetNamespace = "")
    ...
    public ComunidadSearchResponse getCertificadoComunidad(
        @WebParam(partName = "parameters", name = "ComunidadQueryRequest", targetNamespace = "http://rgiaj.dgoj.es/")
        ComunidadQueryRequest parameters
    ) throws Fault;

    @WebMethod(action = "http://rgiaj.dgoj.es/JuegoRGIAJ/removeCertificadoComunidad")
    public void removeCertificadoComunidad(
        @WebParam(partName = "parameters", name = "ComunidadQueryRequest6", targetNamespace = "http://rgiaj.dgoj.es/")
        ComunidadQueryRequest parameters
    ) throws Fault;
    ...
    public ProhibidosResponse prohibidosList(
        @WebParam(partName = "parameters", name = "JugProhibicionQueryRequest", targetNamespace = "http://rgiaj.dgoj.es/")
        JugProhibicionQueryRequest parameters
    ) throws Fault;
    ...
    public ComunidadCertificadoBeanWS getCertificadoActivoComunidad(
        @WebParam(partName = "parameters", name = "ComunidadQueryRequest3", targetNamespace = "http://rgiaj.dgoj.es/")
        ComunidadQueryRequest parameters
    ) throws Fault;
    ...
    public JugHistoricoSearchResponse getHistorico(
        @WebParam(partName = "parameters", name = "JugHistoricoQueryRequest", targetNamespace = "http://rgiaj.dgoj.es/")
        JugHistoricoQueryRequest parameters
    ) throws Fault;

    @Oneway
    @WebMethod(action = "http://rgiaj.dgoj.es/JuegoRGIAJ/removeUsuario")
    public void removeUsuario(
        @WebParam(partName = "parameters", name = "UsuarioQueryRequest3", targetNamespace = "http://rgiaj.dgoj.es/")
        UsuarioQueryRequest parameters
    ) throws Fault;
}
