...
public class ComunidadUsuarioSearchResult {
	 ...
	 */
	private List<UsuarioComunidadBean> results;
	 ...
	 * 
	 */
	public ComunidadUsuarioSearchResult() {
		super();
	}
	 ...
	 * @param results
	 */
	public ComunidadUsuarioSearchResult(List<UsuarioComunidadBean> results) {
		super();
	 ...
	 * @return
	 */
	public List<UsuarioComunidadBean> getResults() {
		return results;
	}
	 ...
	 * @param results
	 */
	public void setResults(List<UsuarioComunidadBean> results) {
		this.results = results;
	}
