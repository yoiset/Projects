...
/**
 * <p>Clase Java para ComunidadQueryRequest complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ComunidadQueryRequest">
 *   &lt;complexContent>
...
@XmlType(name = "ComunidadQueryRequest", propOrder = {
    "codComunidad",
    "idComunidad",
    "descripcion",
    "activo",
...
@XmlSeeAlso({
    UsuarioQueryRequest.class
})
public class ComunidadQueryRequest
