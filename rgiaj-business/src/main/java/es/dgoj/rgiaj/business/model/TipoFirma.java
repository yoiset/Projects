...
/**
 * Estos objetos se utilizan en la configuración de la aplicación para definir los tipos de firma. 
 * Nótese que realmente la clasificación de los tipos de firma no cambia frecuentemente.
 */
@Entity
