...
/**
 * Estos objetos se utilizan en la configuración de la aplicación para definir las comunidades autonomas. 
 * Nótese que realmente la clasificación de las comunidades autonomas no cambia frecuentemente.
 */
@Entity
@Table(name ="JUG_COMUNIDAD")
