...
public class JugHistoricoSearchResult {
	 ...
	 */
	private List<JugHistoricoBean> results;
	...
	/**
	 * Initializes a newly created {@code SearchResult} object initialized to the
	 * results list.
	 * @param results List of results
	 */
	public JugHistoricoSearchResult(List<JugHistoricoBean> results) {
		this.results = results;
	}
	
	public JugHistoricoSearchResult() {
	}
	 ...
	 * @return
	 */
	public List<JugHistoricoBean> getResults() {
		return results;
	}
	 ...
	 * @param results
	 */
	public void setResults(List<JugHistoricoBean> results) {
		this.results = results;
	}
