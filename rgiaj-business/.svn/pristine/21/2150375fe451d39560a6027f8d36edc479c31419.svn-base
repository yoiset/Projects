...
/**
 * Estos objetos se utilizan en la configuración de la aplicación para definir los tipos de documentos de identidad. 
 * Nótese que realmente la clasificación de los tipos de documentos de identidad no cambia frecuentemente.
 */
@Entity
