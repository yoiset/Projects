...
/**
 * Estos objetos se utilizan en la configuración de la aplicación para definir las firmas. 
 * Nótese que realmente la clasificación de las firmas no cambia frecuentemente.
 */
@Entity
