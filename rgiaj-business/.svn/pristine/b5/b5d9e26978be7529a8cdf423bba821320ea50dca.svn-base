...
//		if(query.getFechaCarga()!=null)
	 ...
	 * @see es.dgoj.rgiaj.business.repository.IJugHistoricoDescargasprohRep#getComunidadList()
	 */
	@Override
	public List<JugComunidad> getComunidadList() {
		// TODO Auto-generated method stub
		String hql="select c from JugComunidad c order by c.descripcion asc";
