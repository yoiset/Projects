...
public class TipoFirmaRepositoryTest {

	@Autowired 
	private TipoFirmaRepository<TipoFirma, Long> repository;
	...
	@Test
	public void testGetTipoFirmaById() {
		TipoFirma tipo = this.repository.getTipoFirmaById(Long.valueOf(3));
		assertNotNull(tipo);
	}
