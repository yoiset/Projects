...
/**
 * Estos objetos se utilizan en la configuración de la aplicación para definir los tipos de cargo. 
 * Nótese que realmente la clasificación de los tipos de cargo no cambia frecuentemente.
 */
@Entity
@Table(name ="JUG_CARGO")
