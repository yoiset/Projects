...
public class InterceptorEntradaRegistrarInvocacion extends WSS4JInInterceptor {
	 ...
	 * la operación es "verificarCambiosRGIAJ".
	 * La implementación del método se basa en SoapActionInInterceptor.getSoapAction(Message)
	 * 
	 * Nótese que podría ocurrir que la cabecera de SOAPAction no estuviera en el mensaje HTTP.
	 * En ese caso, el nombre de la operación se sibreescribe desde las operaciones del servicio.
	 */
    private String getNombreOperacion(SoapMessage mensaje) {
    	...
    	int i = -1;
    	// Si soapAction termina en "/", entonces buscamos la operación a partir del separador anterior 
