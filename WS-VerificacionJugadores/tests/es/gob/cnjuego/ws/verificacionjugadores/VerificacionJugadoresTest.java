...
public class VerificacionJugadoresTest extends SpringTestCase{
...
//		assertEquals(cantidadAntes + 1, cantidadDespues);
	...
	public void testVerificarJugador03_3() throws Exception {
		...
		Jugador jugador = new Jugador();
		jugador.setDni("Y0336380L");
		jugador.setNombre("GUSTAVO KAUAª");
		jugador.setApellido1("GARCIA");
	...
	public void testVerificarJugador06_3() throws Exception {
		...
		assertEquals(cantidadAntes + 1, cantidadDespues);
		ResultadoJugador resultado = respuesta.get(0);
		assertEquals("X273388X", resultado.getDni());
		assertEquals("COD901", resultado.getResultadoIdentidad().getCodigo());
		assertEquals("COD901", resultado.getResultadoRGIAJ().getCodigo());
	}	
	 ...
	 **/
	@Test
	public void testVerificarJugador06_4() throws Exception {
		SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
		Jugador jugador = new Jugador();
		jugador.setDni("1444441H");
		jugador.setNombre("LUIS");
		jugador.setApellido1("LOPEZ");
		jugador.setApellido2("REYES");
		jugador.setFechaNacimiento(dateFormat.parse("21/12/1945"));
		...
		assertEquals(cantidadAntes + 1, cantidadDespues);
		ResultadoJugador resultado = respuesta.get(0);
		assertEquals("1444441H", resultado.getDni());
		assertEquals("COD004", resultado.getResultadoIdentidad().getCodigo());
		assertEquals("COD002", resultado.getResultadoRGIAJ().getCodigo());
	}	
...
//		jugador.setApellido2("");
	...
	public void testVerificarJugador11() throws Exception {
		...
		jugador.setNombre("MARIAª ENCINA");
	...
	/**
	 * 1) MODE_ENABLED=2 de JUG_OPERADOR_JUEGO
	 * 2) El parametro  "verificarJugadores.timestamp.opcional" de la tabla de CONFIGURACION está a "false"
	 */
	@Test
	 ...
	 */
	@Test
	public void testVerificarJugador14_1() throws Exception {
		SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
		Jugador jugador = new Jugador();
	 ...
	 */
	@Test
	public void testVerificarJugador14_2() throws Exception {
		SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
		Jugador jugador = new Jugador();
		jugador.setDni("X9135296H");
		jugador.setNombre("antonio luis");
	 ...
	 */
	@Test
	public void testVerificarJugador14_3() throws Exception {
		SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
		Jugador jugador = new Jugador();
		jugador.setDni("X9135296H");
		jugador.setNombre("antonio luis");
	...
	/**1) MODE_ENABLED=2 de JUG_OPERADOR_JUEGO
       ...
       */
	@Test
	public void testVerificarJugador14_4() throws Exception {
		SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
		Jugador jugador = new Jugador();
		jugador.setDni("X9135296H");
		jugador.setNombre("antonio luis");
    ...
    */
	@Test
	public void testVerificarJugador14_5() throws Exception {
		SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
		Jugador jugador = new Jugador();
		jugador.setDni("X9135296H");
		jugador.setNombre("antonio luis");
	 ...
	 * */
	@Test
	public void testVerificarJugador14_6() throws Exception {
		SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
		Jugador jugador = new Jugador();
		jugador.setDni("X9135296H");
		jugador.setNombre("antonio luis");
	 ...
	 */
	@Test
	public void testVerificarJugador15_1() throws Exception {
		SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
		Jugador jugador = new Jugador();
	 ...
	 */
	@Test
	public void testVerificarJugador15_2() throws Exception {
		SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
		Jugador jugador = new Jugador();
		jugador.setDni("18110879N");
		jugador.setNombre("jesus javier");
	 ...
	 */
	@Test
	public void testVerificarJugador15_3() throws Exception {
		SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
		Jugador jugador = new Jugador();
		jugador.setDni("18110879N");
		jugador.setNombre("jesus javier");
	 ...
	 */
	@Test
	public void testVerificarJugador15_4() throws Exception {
		SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
		Jugador jugador = new Jugador();
		jugador.setDni("18110879N");
		jugador.setNombre("jesus javier");
	 ...
	 */
	@Test
	public void testVerificarJugador16_1() throws Exception {
		SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
		Jugador jugador = new Jugador();
		jugador.setDni("Y9999999G");
		jugador.setNombre("Esperanza");
