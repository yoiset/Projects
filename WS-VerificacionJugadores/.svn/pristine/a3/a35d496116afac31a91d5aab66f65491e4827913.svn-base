 ...
 *       &lt;all>
 *         &lt;element ref="{http://intermediacion.redsara.es/scsp/esquemas/ws/peticion}IdentificadorSolicitante"/>
 *         &lt;element ref="{http://intermediacion.redsara.es/scsp/esquemas/ws/peticion}NombreSolicitante"/>
 *         &lt;element ref="{http://intermediacion.redsara.es/scsp/esquemas/ws/peticion}UnidadTramitadora" minOccurs="0"/>
 *         &lt;element ref="{http://intermediacion.redsara.es/scsp/esquemas/ws/peticion}Procedimiento" minOccurs="0"/>
 *         &lt;element ref="{http://intermediacion.redsara.es/scsp/esquemas/ws/peticion}Finalidad"/>
 *         &lt;element ref="{http://intermediacion.redsara.es/scsp/esquemas/ws/peticion}Consentimiento"/>
 *         &lt;element ref="{http://intermediacion.redsara.es/scsp/esquemas/ws/peticion}Funcionario" minOccurs="0"/>
 *         &lt;element ref="{http://intermediacion.redsara.es/scsp/esquemas/ws/peticion}IdExpediente" minOccurs="0"/>
 *       &lt;/all>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
