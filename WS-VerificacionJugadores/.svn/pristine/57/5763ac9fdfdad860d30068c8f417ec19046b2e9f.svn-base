 ...
 * Nótese que antes de que se invoquen los métodos de esta clase, hay unos interceptores
 ...
 * del mensaje SOAP, crear una petición para persistir los mensajes y controlar la seguridad.
 */
public class VerificacionJugadoresImpl implements VerificacionJugadores {
	 ...
	 * Este método es una combinacion de verificarIdentidad() y verificarRGIAJ()
	 * Para cada jugador se retorna el resultado de la validación.
	 * Para poder hacer la comprobación, es necesario:
	 * - Que el operador hace la solicitud esté habilitado
	...
	/**
	 * Recibimos una lista de jugadores y comprobamos si los datos de la identidad (según la Policía)
	 * son correctos. Para cada jugador se retorna el resultado de la validación.
	 * Para poder hacer la comprobación, es necesario:
	 * - Que el operador hace la solicitud esté habilitado
	 * - Que la lista no contenga jugadores repetidos 
	 */
	...
	private List<ResultadoIdentidad> verificarIdentidad(List<Jugador> jugadores, OperadorEntity operador, int idPeticion) throws VerificarIdentidadFault_Exception {
		...
		try {
			...
			// comprobar si es una peticion de recarga de la tabla de configuración. Esto es una peticion excepcional
	 ...
	 * Es decir, si los jugadores tiene prohibido jugar. Para cada jugador se retorna el resultado de la validación.
	 * Para poder hacer la comprobación, es necesario:
	 * - Que el operador hace la solicitud esté habilitado
	 * - Que la lista no contenga jugadores repetidos 
	 */
	 ...
	 * dada, un operador y una petición
	 */
	...
	public ResultadoBajaJugador bajaJugador(Baja bajaJugador)	throws BajaJugadorFault_Exception {
		...
		if (operador.isNullOperador()) {
			...
			fault.setBajaJugadorFault(CodigosVerificacion.ERROR_OPERADOR_INCORRECTO);
	...
	/** Intenta dar de baja a un Jugador a través del Controller
	 * @param bajaJugador
	 * @param operador
	 * @param idPeticion
	 * @return
