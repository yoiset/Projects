...
//	private String email;
	...
	/**
	 * Retorna una instancia que representa al operador cuando éste
	 * no está disponible. Esto simplifica el tratamiento de los siguientes casos:
	 * - El mensaje no incluye las cabeceras con el certificado.
	 * - El operador no está registrado en la BD.
	 */
