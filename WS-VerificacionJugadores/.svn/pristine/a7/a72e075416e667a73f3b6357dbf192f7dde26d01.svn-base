...
public class DatosTestWsDocumentoWS extends SpringTestCase {
	 ...
	 * 1Prueba1.1 Dni que existe en TEST_WS , correcto y está en  RGIAJ (case 31)
	 */
	@Test
	 ...
	 * 1Prueba1.2 Dni que existe en TEST_WS , correcto y está en  RGIAJ (case 31)
	 */
	@Test
	 ...
	 * 1Prueba1.3 Dni que existe en TEST_WS , correcto y está en  RGIAJ (case 31)
	 */
	@Test
...
//		assertEquals("COD002", resultado.getResultadoRGIAJ().getCodigo());
	...
	/**
	 * 1) MODE_ENABLED=1 de JUG_OPERADOR_JUEGO
	 * Prueba4.1 Dni que existe en TEST_WS , correcto y no está en  RGIAJ (Case 27)
	 */
	@Test
	...
	/**
	 * 1) MODE_ENABLED=1 de JUG_OPERADOR_JUEGO
	 * Prueba5.1 Dni que existe en TEST_WS , correcto y no está en  RGIAJ (Case 34)
	 */
	@Test
	...
	/**
	 * 1) MODE_ENABLED=3 de JUG_OPERADOR_JUEGO
	 * Prueba5.3 Dni que existe en TEST_WS , correcto y no está en  RGIAJ (Case 34)
	 */
	@Test
