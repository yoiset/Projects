...
public class InterceptorEntradaControlarSeguridadCliente extends WSS4JInInterceptor {
	 ...
	 * no son válidos, se produce una excepción.
	 * 
	 * Nota: para manipular el mensaje de respuesta y simular una firma inválida, 
	 * alcanza con comentar la línea indicada en el método. Esto se usa como parte
	...
	public void handleMessage(SoapMessage mensaje) throws Fault {
		try {
			...
			// Quitar el comentario de la siguiente línea si queremos invalidar
     ...
     * Esto se usa para alterar el documento y así invalidar la firma digital.
     */
